	...
	<div class="top-menu">
		<ul class="nav navbar-nav pull-right">
			<li
				...
				data-close-others="true" onclick="window.location.href='${pageContext.request.contextPath}/urlInfo/page/myFile'"> 我的文件 </a></li>
			...
			<li class="dropdown dropdown-extended dropdown-inbox dropdown-dark"
				...
				class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
				data-close-others="true" onclick="window.location.href='${pageContext.request.contextPath}/urlInfo/page/attachment'">文件存储<span class="badge badge-default"
					style="right: -17px !important;" id="news_count"></span></a></li>
			<li class="dropdown dropdown-extended dropdown-inbox dropdown-dark"
				id="header_inbox_bar"><a href="javascript:void(0);" onclick="window.location.href='${pageContext.request.contextPath}/urlInfo/page/agency'"
				class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
